...
<?php
    ...
    $header = "Need some fresh creativity in your development team?";
    $tagline = "Augment your team with highly skilled resources from BinaryOps when you need it most!";
    
    require_once '../multi-block-alt.inc.php';
    $blocks = array(
        "header" => "Gain speed and productivity with expert developers from BinaryOps!",
